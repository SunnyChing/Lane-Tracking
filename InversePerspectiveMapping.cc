...
void mcvUpdateCameraInfo ( CameraInfo *cameraInfo, float pitch, float h)
{
  float t = cameraInfo->pitch;
  cameraInfo->pitch = t-pitch * CV_PI/180;
  cameraInfo->cameraHeight = h;
}
