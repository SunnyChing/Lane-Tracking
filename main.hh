...
void ProcessImage(float motionV,float motionW,bool *isInit,const char* filename, IPMInfo& ipmInfo,CameraInfo& cameraInfo,
                  ...
                  gengetopt_args_info& options, ofstream* outputFile = NULL, ofstream* outputFile1=NULL,ofstream* outputFile2=NULL,
                  int index = 0, clock_t *elapsedTime = NULL, LineState* line_state = NULL, LaneState* samples=NULL, LaneState* prestate=NULL,CenterLineState *center_line=NULL);
